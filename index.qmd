...
I'm a Masters graduate in International Development from Sciences Po, currently working as Project Manager at the LearningPlanet Alliance, an Alliance between UNESCO and the Learning Planet Institute.
...
education %>%
  ...
  cols_width(
    logo ~ px(70),   # Adjust width for logo column
    text ~ px(500)   # Adjust width for text column
  )
```
...
experience <- tribble(
  ...
  #lp 
  "images/1664269244656.jpg", "https://www.learning-planet.org/", "LearningPlanet Alliance", "Project Manager", "Sept 2022 - Present",
  #lp 
  "Cs3IebYp_400x400.jpg", "https://itjpsl.com/", "International Truth and Justice Project", "Researcher", "Sept 2023 - Feb 2024",
  # oxfam
